...
// Enhanced Stats Cards with proper active users count
const StatsCards = ({ refreshTrigger }: { refreshTrigger: number }) => {
  ...
  const fetchStats = useCallback(async () => {
    try {
      ...
      // Fix: Properly count active users by checking both status and isActive properties
      const activeUsersCount = users.filter(user => {
        // Check if status property exists and is 'active' (case-insensitive)
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 mb-8 mt-6">
              ...
              <Tabs defaultValue="admins" value={activeTab} onValueChange={setActiveTab} className="w-full">
                <div className="px-4 sm:px-6 pt-6">
                  <TabsList className="grid w-full grid-cols-3 gap-2 p-1 bg-gradient-to-r from-gray-100 to-gray-200/50 dark:from-gray-800 dark:to-gray-700/50 rounded-2xl">
                    <TabsTrigger 
                      value="admins" 
                      className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-white data-[state=active]:to-red-50/50 data-[state=active]:dark:from-gray-800 data-[state=active]:dark:to-red-950/20 data-[state=active]:shadow-lg rounded-xl py-3 transition-all text-xs sm:text-sm"
                    >
                      <div className="flex items-center gap-2">
                    ...
                    <TabsTrigger 
                      value="managers" 
                      className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-white data-[state=active]:to-emerald-50/50 data-[state=active]:dark:from-gray-800 data-[state=active]:dark:to-emerald-950/20 data-[state=active]:shadow-lg rounded-xl py-3 transition-all text-xs sm:text-sm"
                    >
                      <div className="flex items-center gap-2">
                    ...
                    <TabsTrigger 
                      value="supervisors" 
                      className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-white data-[state=active]:to-amber-50/50 data-[state=active]:dark:from-gray-800 data-[state=active]:dark:to-amber-950/20 data-[state=active]:shadow-lg rounded-xl py-3 transition-all text-xs sm:text-sm"
                    >
                      <div className="flex items-center gap-2">
